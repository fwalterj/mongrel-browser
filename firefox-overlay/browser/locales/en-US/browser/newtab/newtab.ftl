...
# This tooltip is for the context menu of story cards or Top Sites
# Variables:
...
## Empty Section States: These show when there are no more items in a section. Ex. When there are no more story recommendations, in the space where there would have been stories, this is shown instead.
...
# and understand their personal finances – from saving money to buying a home.
...
# aspects of their lives – from mental health to productivity.
...
newtab-download-mobile-highlight-body-variant-c = Did you know you can take { -brand-product-name } on the go? Same browser, wherever you are.
