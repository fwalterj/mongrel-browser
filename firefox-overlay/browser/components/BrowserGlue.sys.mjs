...
ChromeUtils.defineESModuleGetters(lazy, {
  ...
  MongrelAdblockService:
    "resource:///modules/MongrelAdblockService.sys.mjs",
  MongrelImageBulkDownload:
    "resource:///modules/MongrelImageBulkDownload.sys.mjs",
  MongrelImageOverlayManager:
    "resource:///modules/MongrelImageOverlayManager.sys.mjs",
  MongrelNightMode:
    "resource:///modules/MongrelNightMode.sys.mjs",
  MongrelPlayerService:
    "resource:///modules/MongrelPlayerService.sys.mjs",
  MongrelSanctuaryMode:
    "resource:///modules/MongrelSanctuaryMode.sys.mjs",
  MongrelStartpageOverride:
    "resource:///modules/MongrelStartpageOverride.sys.mjs",
  MongrelTableauIntegration:
    "resource:///modules/MongrelTableauIntegration.sys.mjs",
  MongrelThemeEffects:
    "resource:///modules/MongrelThemeEffects.sys.mjs",
...
BrowserGlue.prototype = {
  ...
  _dispose: function BG__dispose() {
    ...
    try { lazy.MongrelStartpageOverride.destroy?.(); } catch (e) { console.error(e); }
    try { lazy.MongrelThemeEffects.destroy(); } catch (e) { console.error(e); }
  },
  ...
  _beforeUIStartup: function BG__beforeUIStartup() {
    ...
    // Mongrel front-end services. Order matches April 27 dogfood reference build:
    // start page override first (so AboutNewTab.newTabURL is set before any tab
    // observers run), then theme/chrome effects, then ambient features.
    try { lazy.MongrelAdblockService.init(); } catch (e) { console.error(e); }
    try { lazy.MongrelPlayerService.init(); } catch (e) { console.error(e); }
    try { lazy.MongrelImageBulkDownload.init(); } catch (e) { console.error(e); }
    try { lazy.MongrelImageOverlayManager.init(); } catch (e) { console.error(e); }
    try { lazy.MongrelStartpageOverride.init(); } catch (e) { console.error(e); }
    try { lazy.MongrelTableauIntegration.init(); } catch (e) { console.error(e); }
    try { lazy.MongrelThemeEffects.init(); } catch (e) { console.error(e); }
    try { lazy.MongrelNightMode.init(); } catch (e) { console.error(e); }
    try { lazy.MongrelSanctuaryMode.init(); } catch (e) { console.error(e); }
