...
// Mongrel legacy dark mode prefs (kept for migration path in MongrelNightMode)
pref("mongrel.darkmode.enabled", false);
pref("mongrel.darkmode.follow_system", false);
pref("mongrel.darkmode.force_fallback", false);
pref("mongrel.darkmode.theme", "follow");
pref("mongrel.darkmode.site_exceptions", "");

// Load userContent.css / userChrome.css from profile (required for Night Mode CSS injection)
pref("toolkit.legacyUserProfileCustomizations.stylesheets", true);

// Mongrel Night Mode — web-content dark theme system
pref("mongrel.nightmode.theme", "follow");
pref("mongrel.nightmode.engine", "advanced");
pref("mongrel.nightmode.extend_to_pages", false);
pref("mongrel.nightmode.adaptive_tinting", false);
pref("mongrel.sanctuary.enabled", false);

// Mongrel Personalize — chrome mood and bloom intensity
pref("mongrel.personalize.mood", "default");
pref("mongrel.personalize.bloom", 0);
pref("mongrel.personalize.adapt_to_site", false);
pref("mongrel.personalize.night_mode.enabled", false);
pref("mongrel.personalize.night_mode.apply_to_web", false);
pref("mongrel.personalize.night_mode.variant", "follow");

// Mongrel Player — built-in media player and HLS downloader
pref("mongrel.player.enabled", true);
pref("mongrel.player.overlay_enabled", true);
pref("mongrel.player.download_enabled", true);
pref("mongrel.player.download_all_enabled", true);
pref("mongrel.image_overlay.buttons_enabled", true);

// Media compatibility defaults for social video sites.
...
// Work around frozen-video presentation on some macOS GPU stacks.
pref("gfx.webrender.software", true);
pref("layers.acceleration.disabled", true);

// Mongrel Ad Blocking
pref("mongrel.adblock.traditional.enabled", true);
pref("mongrel.adblock.cosmetic.enabled", false);
pref("mongrel.adblock.invisible.enabled", false);
pref("mongrel.adblock.ad_domains", "");

// Mongrel Downloads — auto-save images and video to disk without prompting
pref("browser.helperApps.neverAsk.saveToDisk", "image/png,image/jpeg,image/webp,image/gif,image/avif,image/svg+xml,video/mp4,video/webm,video/ogg,video/quicktime,video/x-matroska,audio/mpeg,audio/ogg,audio/flac");

// Enhanced Tracking Protection — default to Standard to avoid breaking media-heavy sites.
pref("browser.contentblocking.category", "standard");

// Disable sponsored/promoted content in new tab
pref("browser.newtabpage.activity-stream.showSponsored", false);
pref("browser.newtabpage.activity-stream.showSponsoredTopSites", false);
pref("browser.newtabpage.activity-stream.feeds.topsites", false);
pref("browser.newtabpage.activity-stream.feeds.section.topstories", false);

// Enable backdrop-filter in chrome CSS
pref("layout.css.backdrop-filter.enabled", true);

// Preferences UI expects this startup-mode pref to exist.
...
pref("browser.startup.homepage",            "chrome://browser/content/newtab.html");
...
// Use the same default engine in regular and private windows.
...
// Mongrel uses its own image overlay for visual search; disable the duplicate context menu item.
...
// Mongrel Alpha 0.1: disable Discovery Stream by default to prevent Pocket-backed requests.
...
// Mongrel Phase 6: keep all Discoverystream/Pocket reporting disabled.
pref("browser.newtabpage.activity-stream.discoverystream.reportAds.enabled", false);

// Mongrel Phase 7: explicitly disable Pocket-backed sponsored stories and top stories feeds.
// These default to true in ActivityStream.sys.mjs; we force them false as a belt-and-suspenders
// guard independent of discoverystream.enabled above.
pref("browser.newtabpage.activity-stream.showSponsored", false);
pref("browser.newtabpage.activity-stream.showSponsoredTopSites", false);
pref("browser.newtabpage.activity-stream.feeds.section.topstories", false);
...
// Mongrel native start page defaults.
pref("mongrel.startpage.search_engine", "ddg");
pref("mongrel.startpage.links", "[]");
pref("mongrel.startpage.show_settings_btn", true);
pref("mongrel.startpage.show_history_btn", true);
pref("mongrel.startpage.show_passwords_btn", false);
...
// Mongrel: disable Firefox welcome/onboarding pages
...
// Mongrel: enable FxAccounts so Sync/account surfaces can initialize.
...
// ── Mongrel Privacy & Telemetry Hardening ─────────────────────────────────

// Disable Glean / unified telemetry
...
// Disable data reporting and health report upload
pref("datareporting.healthreport.uploadEnabled", false);
pref("datareporting.policy.dataSubmissionEnabled", false);
pref("datareporting.sessions.current.clean", true);

// Disable Normandy / Shield studies and A/B experiments
...
// Disable crash reporter submission
pref("breakpad.reportURL", "");
pref("browser.tabs.crashReporting.sendReport", false);
pref("browser.crashReports.unsubmittedCheck.autoSubmit2", false);
pref("browser.crashReports.unsubmittedCheck.enabled", false);

// Disable network predictor and prefetching
pref("network.predictor.enabled", false);
pref("network.prefetch-next", false);
pref("network.dns.disablePrefetch", true);

// Disable geo/region network probing
pref("browser.region.network.url", "");
pref("browser.region.update.enabled", false);

// Disable ML / AI features
pref("browser.ml.enable", false);

// Disable Firefox Suggest / Pocket
pref("browser.urlbar.suggest.pocket", false);
pref("browser.urlbar.pocket.featureGate", false);
pref("extensions.pocket.enabled", false);

// Disable sponsored urlbar suggestions
pref("browser.urlbar.suggest.sponsored", false);
pref("browser.urlbar.quicksuggest.enabled", false);

// Disable captive portal detection (reduces outbound connections)
pref("network.captive-portal-service.enabled", false);

// Disable Firefox Accounts new-device onboarding pings
pref("identity.fxaccounts.telemetry.clientAssociation.enabled", false);

// Disable beforeunload dialogs — prevents anti-adblock scripts and hostile
// sites from blocking the reload/back button with "are you sure?" prompts.
