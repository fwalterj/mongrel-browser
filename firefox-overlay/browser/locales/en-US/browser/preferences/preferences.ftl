...
pane-darkmode-title = Personalization
category-darkmode =
    .tooltiptext = { pane-darkmode-title }

pane-startpage-title = Start Page
category-startpage =
    .tooltiptext = { pane-startpage-title }

pane-adblock-title = Ad Blocking
category-adblock =
    .tooltiptext = { pane-adblock-title }
...
startpage-title = Mongrel Start Page
startpage-description = Customize the new tab page buttons and quick links.
startpage-show-settings-btn =
    .label = Show Settings button
startpage-show-history-btn =
    .label = Show History button
startpage-show-passwords-btn =
    .label = Show Passwords button
startpage-download-all-images-toggle =
    .label = Enable "Download All Images" toolbar button
startpage-image-overlay-buttons-toggle =
    .label = Enable image download/search hover buttons
startpage-links-title = Quick Links
startpage-links-description = JSON array of link objects. Each entry needs "title" and "url" fields.
startpage-links-textarea =
    .placeholder = Example: title/url objects for GitHub, MDN, YouTube

personalization-mood-title = Mood
personalization-mood-description = Shifts the browser's color temperature — accent glows and highlights — without changing the dark foundation. All-Black activates deep-black page dark mode.
mood-pure =
    .label = Cobalt
mood-infernal =
    .label = Garnet
...
personalization-nightmode-title = Day & Night
personalization-nightmode-description = Control how websites appear. Deep Black replaces page colors with true black. Night Warmth adds a warm sepia temperature shift without changing the dark mode.
night-mode-theme-label = Page appearance
night-mode-theme-follow =
    .label = None (Off)
night-mode-theme-abyssal =
    .label = Deep Black
night-mode-theme-night =
    .label = Night Warmth (Sepia)

adblock-info-title = Ad & Tracker Blocking
adblock-info-description = Mongrel blocks ads and trackers quietly in the background. For per-site control, allowlists, and custom filter lists, use the uBlock Origin extension installed in your toolbar.
...
content-blocking-enhanced-tracking-protection = Tracker Blocking

content-blocking-section-top-level-description = Websites often include hidden code that tracks where you go online. { -brand-short-name } blocks this code silently — no ad networks following you between sites, no data brokers watching in the background.
...
content-blocking-etp-standard-desc = Balanced protection — blocks most trackers while keeping pages working normally. Good for everyday use.
content-blocking-etp-strict-desc = Maximum blocking — a handful of sites may behave oddly, but your privacy is significantly stronger.
content-blocking-etp-custom-desc = You decide exactly what gets blocked. For advanced users who want full control.
content-blocking-etp-blocking-desc = { -brand-short-name } blocks the following:

content-blocking-private-windows = Trackers in private windows
content-blocking-cross-site-cookies-in-all-windows2 = Cookies that follow you across sites
content-blocking-cross-site-tracking-cookies = Tracking cookies (follow you between sites)
content-blocking-all-cross-site-cookies-private-windows = Cross-site cookies in private windows
content-blocking-isolate-cross-site-cookies = Keep each site's cookies separate
content-blocking-social-media-trackers = Social media trackers (Facebook, X, etc.)
content-blocking-all-cookies = All cookies
content-blocking-unvisited-cookies = Cookies from sites you haven't visited
content-blocking-all-windows-tracking-content = Trackers in all windows
content-blocking-all-cross-site-cookies = All cross-site cookies
content-blocking-cryptominers = Cryptocurrency miners (steal your CPU)
content-blocking-fingerprinters = Fingerprinters (identify you without cookies)
...
content-blocking-etp-standard-tcp-rollout-description = Total Cookie Protection keeps each site’s cookies separate, so trackers can’t use them to follow you around the web.
content-blocking-etp-standard-tcp-rollout-learn-more = Learn more

content-blocking-etp-standard-tcp-title = Includes Total Cookie Protection — keeps sites from tracking you via cookies

content-blocking-warning-title-2 = Heads up: some sites may not work perfectly in Strict mode
content-blocking-warning-title-custom = Heads up: some sites may not work perfectly with your custom settings
